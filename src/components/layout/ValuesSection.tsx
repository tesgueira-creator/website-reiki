    ...
    <section className="bg-[var(--color-background)] relative overflow-hidden section-padding">
      ...
      <div className="content-container content-grid relative z-10">
        ...
        >
          ...
          <p className="text-text-secondary max-w-2xl mx-auto leading-relaxed text-lg font-light text-center">
            Os princípios sagrados que guiam cada momento da minha prática
            terapêutica
          </p>
        </motion.div>
